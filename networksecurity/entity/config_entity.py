...
print(training_pipeline.FILENAME)
...
class ModelTrainerConfig:
    ...
    def __init__(self, training_pipleline_config:TrainingPipelineConfig):
        
        self.model_trainer_dir:str = os.path.join(training_pipleline_config.artifacts_dir, 
